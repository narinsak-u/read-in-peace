  ...
  <div class="my-12 rounded-sm border border-border bg-card p-6">
    <div class="flex items-center justify-between">
      ...
      >
        Cancels on
        {{
          membershipStore.membership.currentPeriodEnd
            ? formatDate(membershipStore.membership.currentPeriodEnd)
            : ""
        }}
      </span>
    </div>
    ...
    <ConfirmDialog
      ...
      description="Your plan will remain active until the end of the billing period. You'll lose access to premium features after that."
