...
function publishReply(reviewId: number) {
  ...
  reviews.value = reviews.value.map((r) =>
    r.id === reviewId
      ? {
          ...r,
          replies: [...r.replies, `${replyText.value.trim()} — Jamie S.`],
        }
      : r,
  );
  replyText.value = "";
    ...
    <main class="mx-auto max-w-7xl px-4 py-10 md:px-6 lg:py-14">
      ...
      >
        ...
        <div class="flex flex-col justify-center">
          ...
          >
            <span>{{ book.year }}</span
            ><span>•</span><span>{{ book.pages }} pages</span><span>•</span
          ...
          <div class="mt-7 flex items-center gap-3">
            <span class="text-lg text-primary"
              >★★★★<span class="text-foreground/10">★</span></span
            >
          ...
          <div class="mt-8 flex flex-wrap gap-3">
            <Button variant="archivalGhost" @click="saved = !saved"
              ...
              {{ saved ? "Saved to list" : "Save to list" }}</Button
            >
            <Button
              ...
              "
              ><MessageCircle /> Read discussion</Button
            >
          </div>
        </div>
      ...
      <section id="discussion" class="scroll-mt-24 py-14">
        <div class="grid gap-12 lg:grid-cols-[minmax(0,1fr)_340px]">
          <div>
            <div
              class="mb-8 flex items-end justify-between border-b border-border pb-3"
            >
              <div>
                <p
              ...
              >
                <div class="flex gap-4">
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-3 max-w-3xl leading-7 text-foreground/80">
                      {{ item.text }}
                    </p>
                    <div class="mt-3 flex gap-2">
                      ...
                      <Button
                        ...
                        variant="archivalGhost"
                        @click="
                          replyingTo = replyingTo === item.id ? null : item.id
                        "
                        >Reply ({{ item.replies.length }})</Button
                      >
                    </div>
                    <div
