...
export const mockReviews = [
  { user: "Hana", avatar: "H", rating: 5, text: "Read it in two sittings. The prose has a hush to it — like the world goes quieter while you're inside." },
  { user: "Jonas", avatar: "J", rating: 4, text: "Beautifully restrained. The second act drifts a little but the ending earned it." },
  { user: "Priya", avatar: "P", rating: 5, text: "One of those books I'll keep on the nightstand. Already lent my copy to a friend." },
];
